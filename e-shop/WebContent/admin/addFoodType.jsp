			...
			<div class="admin">
				<div class="admin-biaogelist">
					...
					<div class="listbiaoti am-cf">
						<ul class="am-icon-flag on">新增商品类型
						</ul> 
					</div>

					<div class="fbneirong">
						<form class="am-form" action="${basePath}/food/addFoodType.action" method="post" enctype="multipart/form-data">
							<div class="am-form-group am-cf">
								<div class="zuo">商品名：</div>
								<div class="you">
									<input type="text" class="am-input-sm" id="doc-ipt-email-1"
										placeholder="请输入商品类别名" name="name">
								</div>
							</div>						
							
							<div class="am-form-group am-cf" style="height:60px;">
							</div>
